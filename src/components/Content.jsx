...
export function Gallery({ onOpenLightbox, preview = false, bare = false }) {
  ...
  return (
    <section id="portfolio" className="py-20 md:py-32 aurora">
...
// export function HomeGallery({ onOpenLightbox, preview = false, bare = false }) {
//   const [filter, setFilter] = useState("all");
//   const [numCols, setNumCols] = useState(3);
...
//   const items = Homeartworks.filter((a) => filter === "all" || a.cat === filter);
